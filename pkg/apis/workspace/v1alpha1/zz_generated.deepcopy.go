...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ComponentPodAdditions) DeepCopyInto(out *ComponentPodAdditions) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ComponentPodAdditions.
func (in *ComponentPodAdditions) DeepCopy() *ComponentPodAdditions {
	if in == nil {
		return nil
	}
	out := new(ComponentPodAdditions)
	in.DeepCopyInto(out)
	return out
}
